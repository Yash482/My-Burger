    ...
    render() {
        ...
        return (
            <Aux>
                ...
                <Buildcontrols purchasable={purchasable} disable = {disableInfo} totalPrice = {this.state.totalPrice} controls = {this.state.ingredients} add = {this.addIngredientHandler} remove = {this.removeIngredientHandler}/>
            </Aux>
        )
    }
}
